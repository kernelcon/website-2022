...
var _TabListComponent = require('./TabListComponent');

var _TabListComponent2 = _interopRequireDefault(_TabListComponent);
  ...
  _createClass(TabList, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['selection', 'children', 'className']);

      var verticalOrientation = selection.isVertical();

      return _react2.default.createElement(
        _TabListComponent2.default,
        _extends({}, props, {
...
exports.default = (0, _withTabSelection2.default)(TabList);