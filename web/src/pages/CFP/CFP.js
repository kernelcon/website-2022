	...
	render() {
		return (
          ...
          Create something fun in your homelab? Develop a new technique? Wish you could spare someone the horrors you faced? Impart your wisdom, start the difficult conversations, submit your work to our CFP!
					...
					<p className="tab-paragraph">In 2019, we exceeded our targets with two speaking tracks, several conference events, and competitions for more than 350 attendees.  In 2020 we were one of the first security conferences to pivot to a pure-virtual format, populating two speaker live-streams, offering pre-conference training, and innovative virtual activities for our more than 400 paid attendees.  With the time to consider and plan for 2021 in a virtual context, we pioneered HackLive!, an online event that saw experts in various hacking disciplines hack challenges in their domain live.  Kernelcon partnered with the Ultimate Hacking Championship and brought HackLive! to thousands of world-wide viewers.</p>
